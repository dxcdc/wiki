...
O departamento de Recursos Humanos do **Centro de Desenvolvimento e Cidadania (CDC)** é focado na gestão e bem-estar de nossos colaboradores e voluntários. O setor gerencia admissões, controle de jornada de trabalho (ponto), acompanhamento de metas em projetos e os pacotes de benefícios e saúde.
...
### Ponto e Projetos
* ⏰ **[EZ Point](https://client2.ezpointweb.com.br/)** *(Sistema)* — Acesso ao ponto eletrônico para registro diário e consulta de espelho de ponto.
...
* 💳 **[Vale Alimentação (Caju)](https://auth.caju.com.br/)** *(Benefício)* — Gestão e saldo do cartão de benefícios flexíveis (Alimentação e Refeição).
...
Consulte as apostilas abaixo para usufruir de seus direitos e cumprir os processos mensais de RH.

### ⏰ Controle de Ponto
* **[Manual: Como assinar e justificar faltas no EZ Point]** — Regras de prazos para justificativas de ausências, atestados médicos e assinatura do espelho mensal.

### 🥗 Benefícios e Alimentação
* **[Guia: Como transferir saldo entre categorias no cartão Caju]** — Entenda como usar as categorias de refeição, alimentação, mobilidade e saúde no aplicativo Caju.

### 🩺 Saúde e Sinistros
* **[Tutorial: Solicitação de Reembolso Bradesco Saúde]** — Passo a passo para enviar pedidos de reembolso para exames ou consultas fora da rede credenciada.
