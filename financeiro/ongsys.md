...
Esta documentação apresenta instruções rápidas para utilização do **ONGSYS**, o ERP integrado de gestão oficial do **Centro de Desenvolvimento e Cidadania (CDC)**. Ele é focado no terceiro setor, utilizado para controle contábil, financeiro, conciliação bancária, faturamento e prestação de contas de convênios.

Escolha o nível relacionado ao seu perfil ou consulte o Nível Base para revisar conceitos, fluxos e procedimentos que todos os usuários devem conhecer.

> **Importante:** as telas e opções disponíveis podem variar conforme o perfil de acesso. Conhecer um procedimento não significa possuir permissão para executá-lo.
